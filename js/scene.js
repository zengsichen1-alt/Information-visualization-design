...
import { HDRLoader } from '../threejs/jsm/loaders/HDRLoader.js';
import { OrbitControls } from '../threejs/jsm/controls/OrbitControls.js';
import { MouseFollowCameraController } from './mouseEvent.js';
//右手坐标系
...
let moon4C;
    gltfLoader.load('model/moon4.glb', function(gltf){
            ...
            const Apollo16R = getRotationForLatLon(8.97, 15.5);//8.97°N, 15.5°E
            ...
            function getPositionFromLatLon(lat, lon, radius) {
                ...
                const Apollo16P = getPositionFromLatLon(8.97, 15.5, moonRadius);//8.97°N, 15.5°E
